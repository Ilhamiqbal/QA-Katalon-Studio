...
WebUI.setText(findTestObject('Register/input_Phone Number_phone'), '08212222333')
...
WebUI.setText(findTestObject('Register/input_Confirmation Password_confirmPassword'), 'Admin#123')
